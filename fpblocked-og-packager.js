...
function buildLandingHtml({ appName, displayName = appName, build, bookmarklet, manifestUrl, screenshotUrl, iconUrl }) {
  ...
  return [
    ...
    "      <div class=\"card\"><strong>Export blocked</strong><p>Saves blocked user IDs and names from the selected Page into a reusable JSON package.</p></div>",
    "      <div class=\"card\"><strong>Import blocked</strong><p>Applies a saved blocked-user JSON package to the selected Page one user ID at a time.</p></div>",
