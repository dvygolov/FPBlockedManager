(function fpblockedmanagerLoader(config) {
  "use strict";

  const loaderConfig = Object.assign({
    app: "FPBlockedManager",
    manifestUrl: "https://fpblockedmanager.pages.dev/fpblocked/latest/manifest.html",
    embeddedManifest: null,
    cacheKey: "fpblockedmanager.loader.cache.v1",
    timeoutMs: 45000,
  }, config || {});
  const guardKey = "__FPBlockedManagerLoader";
  ...
  const executePayload = (source, build) => new Promise((resolve, reject) => {
    const blob = new Blob([
      source,
      `\n//# sourceURL=fpblockedmanager://${build}/payload.js`,
